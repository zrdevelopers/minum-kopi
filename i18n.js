...
// Check if window object is defined (i.e., running on the client side)
if (typeof window !== 'undefined') {
  const language = localStorage.getItem('i18nextLng') || 'id';
  i18nConfig.lng = language; // Set the initial language from localStorage
}
...
i18n
  ...
  .init(i18nConfig)
  .then(() => {
    // Ensure the language is updated in localStorage whenever it changes
